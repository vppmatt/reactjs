...
export const getAllPaymentsFetchVersion = () => {
    ...
    const transactionsPromise = fetch("http://localhost:8080/api/cctransaction", {
        method: "GET",
...
export const getAllPaymentsAxiosVersion = () => {
    ...
    const transactionsPromise = axios({url : "http://localhost:8080/api/cctransaction", method: "GET", headers : {'Accept': 'application/json'} });
